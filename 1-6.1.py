...
class CanvasDemo:
  def __init__(self):
     ...
     btPloygon = Button(frame, text="다각형", command=self.displayPolygon)
     ...
     def displayPoolygon(self):
        self.canvas.create_polygon(10, 10, 190, 90, 30, 50, tags="polygon")

     def displayLine(self):
        self.canvas.create_line(10, 10, 190, 90, fill = "red", tags="line")
        self.canvas.create_line(10, 10, 190, 90, width = 9, arrow = "last",
        artivefill = "blue", tags = "line")


     def displayString(self):
        self.canvas.create_text(85, 40, text= "안녕, 나는 문자열이야", 
                                font="굴림체 10 bold underline", tags="string")
